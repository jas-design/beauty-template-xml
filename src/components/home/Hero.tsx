    ...
    <section className="bg-mint-light min-h-screen pt-32 pb-10 px-6">
      <div className="max-w-[1600px] mx-auto space-y-6">
        ...
        <div className="flex flex-col xl:flex-row gap-6">
          {/* Main Content Box */}
          <div className="flex-1 bg-[#A1DBDB] rounded-[20px] overflow-hidden relative min-h-[500px] flex">
            ...
            <div className="relative z-10 w-full flex flex-col lg:flex-row items-center">
              ...
              {/* Right Image Side */}
              <div className="lg:w-2/5 h-full flex items-end justify-center lg:justify-end self-end">
                <img 
                  src={beautyModelImg} 
                  alt="Cutisure Beauty" 
                  className="h-full object-contain max-h-[500px] w-auto select-none pointer-events-none translate-y-2" 
                />
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <div className="bg-dark-teal rounded-[40px] p-12 flex flex-col justify-between relative overflow-hidden min-h-[300px]">
            ...
            <div className="mt-8 flex items-center gap-6 relative z-10">
              ...
              <div className="text-3xl font-bold text-white tracking-widest">+1 (234) 567-8910</div>
            </div>
