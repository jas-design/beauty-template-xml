    ...
    <section className="py-24 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
        ...
        <div className="relative order-1 lg:order-2 flex justify-end">
          ...
          <div className="relative w-[85%] rounded-[30px] overflow-hidden shadow-2xl z-10 aspect-[4/5]">
            <img
              src="https://images.unsplash.com/photo-1570172619380-2aa063da5da8?auto=format&fit=crop&q=80&w=1000"
              alt="Cutisure Beauty Treatment"
              className="w-full h-full object-cover"
            />
          </div>

          {/* Secondary Smaller Image (Left Overlapping) */}
          <div className="absolute left-[-5%] bottom-[10%] w-[50%] z-20 rounded-[20px] overflow-hidden border-[10px] border-white shadow-2xl aspect-[3/4]">
             <img
              src={treatmentImg}
